...
class OrderApi
{
     ...
     */
    protected function orderAcknowledgeRequest($merchantOrderAcknowledgementRequest = null)
    {
        ...
        if (isset($merchantOrderAcknowledgementRequest)) {
            $_tempBody = $merchantOrderAcknowledgementRequest;
        }
     ...
     *
     * @param  \ChannelEngine\Merchant\ApiClient\Model\OrderStatusView[] $statuses Order status(es) to filter on. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function orderGetByFilterRequest($statuses = null, $emailAddresses = null, $merchantOrderNos = null, $channelOrderNos = null, $fromDate = null, $toDate = null, $fromCreatedAtDate = null, $excludeMarketplaceFulfilledOrdersAndLines = null, $fulfillmentType = null, $onlyWithCancellationRequests = null, $page = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function orderUpdateRequest($merchantOrderCommentUpdateRequest = null)
    {
        ...
        if (isset($merchantOrderCommentUpdateRequest)) {
            $_tempBody = $merchantOrderCommentUpdateRequest;
        }
